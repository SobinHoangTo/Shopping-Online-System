        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12 col-lg-5 d-flex align-items-center">
            <div class="d-flex gap-3 flex-column w-100 ">
              <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:9999/OSS_G1_SE1820_SWD392/Login&response_type=code&client_id=483761590621-einkggqe7csa8ru06j1j48nm8ijjg89c.apps.googleusercontent.com&approval_prompt=force" class="btn btn-lg btn-danger">
